export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'nanchins',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Nanchins',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'nanchins.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://nanchins.com',
