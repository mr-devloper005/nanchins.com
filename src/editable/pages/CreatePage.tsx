...
const fieldClass = 'rounded-2xl border border-[var(--editable-border)] bg-white px-4 py-3 text-sm font-bold text-[var(--editable-page-text,#6367FF)] outline-none transition placeholder:text-current/35 focus:border-current'
...
export default function CreatePage() {
  ...
  if (!session) {
    return (
      <EditableSiteShell>
        <main className="min-h-screen bg-[var(--editable-page-bg,#FFDBFD)] px-4 py-16 text-[var(--editable-page-text,#6367FF)] sm:px-6 lg:px-8">
          <section className="mx-auto grid max-w-5xl gap-8 rounded-[2.8rem] border border-[var(--editable-border)] bg-white/75 p-7 shadow-[0_30px_90px_rgba(15,23,42,0.08)] md:grid-cols-[0.9fr_1.1fr] md:p-10">
            <div className="flex h-full min-h-72 items-center justify-center rounded-[2rem] bg-[var(--editable-page-text,#6367FF)] text-[var(--editable-page-bg,#FFDBFD)]">
            ...
            <div className="self-center">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link href="/login" className="inline-flex items-center gap-2 rounded-full bg-[var(--editable-page-text,#6367FF)] px-6 py-3 text-sm font-black text-[var(--editable-page-bg,#FFDBFD)]">Login <ArrowRight className="h-4 w-4" /></Link>
  ...
  return (
    <EditableSiteShell>
      <main className="min-h-screen bg-[var(--editable-page-bg,#FFDBFD)] text-[var(--editable-page-text,#6367FF)]">
        <section className="mx-auto max-w-[var(--editable-container)] px-4 py-10 sm:px-6 lg:px-8 lg:py-16">
          <div className="grid gap-8 rounded-[2.8rem] border border-[var(--editable-border)] bg-white/75 p-6 shadow-[0_30px_90px_rgba(15,23,42,0.08)] backdrop-blur lg:grid-cols-[0.85fr_1.15fr] lg:p-10">
            ...
            <form onSubmit={submit} className="rounded-[2.2rem] border border-[var(--editable-border)] bg-[var(--editable-page-bg,#FFDBFD)] p-5 sm:p-7">
              ...
              <button type="submit" className="mt-5 inline-flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-[var(--editable-page-text,#6367FF)] px-6 text-sm font-black uppercase tracking-[0.18em] text-[var(--editable-page-bg,#FFDBFD)] transition hover:-translate-y-0.5">
